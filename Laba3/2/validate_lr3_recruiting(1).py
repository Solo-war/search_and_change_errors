...
DATASET = "recruiting_dataset_with_errors.csv"
ERRORS_MAP = "recruiting_errors_map.csv"
...
# 7–10 признаков (+ target). Здесь 8 признаков: id..remote_preference, и target.
...
bad_age = df[pd.to_numeric(df["age"], errors="coerce").notna()]
bad_age = bad_age[(bad_age["age"] < 18) | (bad_age["age"] > 55)]
print("Out-of-range ages:", len(bad_age))
